                ...
                <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
                    <div className="bg-white py-8 px-4 sm:px-10">
                        ...
                        <form className="mt-6 space-y-6" action="#" method="POST">
                            ...
                            <div>
                                <button type="submit" className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-black hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">Login</button>
                            </div>
                        </form>

                        <div className="mt-6 text-center">
                            <a href="#" className="font-medium text-black hover:text-gray-800">Register Now</a>
                        </div>
                    </div>
                </div>
            </div>
